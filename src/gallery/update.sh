...
flist=("apeejay_model_town-22_october_2021-being_respectful-word_web-p2" \
  "apeejay_noida_sc_16_a-2_feb_2022-2_Feb_2022-doing_our_best-p4" \
  "apeejay_panchsheel-27_jul_2022-p18" \
...
for i in "${!flist[@]}"; do
  cat <<EOF >> $OUTFILE
    <div class="slides-item slide-$((i+1))" id="slide-$((i+1))" aria-label="slide $((i+1)) of ${#flist[@]}" tabindex="0">\
